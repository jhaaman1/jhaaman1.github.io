...
const ContactLinks = () => {
    ...
    return (
        <>
            ...
            <Button variant="contained" href={"https://drive.google.com/file/d/1UCYxCb_wCqyEoNb4Xzq5dfnR96abSQZq/view?usp=sharing"} target="_blank" className={classes.themeBtn} download>View Resume</Button>
        </>
    );
};
