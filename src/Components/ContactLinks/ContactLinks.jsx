...
const ContactLinks = () => {
    ...
    return (
        <>
            ...
            <Button variant="contained" href={"https://drive.google.com/file/d/1P1a9S-ZMI_tBpQZI2sSh0P0v20kHsCch/view?usp=share_link"} target="_blank" className={classes.themeBtn} download>View Resume</Button>
        </>
    );
};
